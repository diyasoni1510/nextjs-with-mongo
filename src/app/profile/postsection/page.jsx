...
const PostSection = () => {
  ...
  const getUserDp = (username) => {
    const response  =  axios.post("/api/users/getuserfromusername",{username})
    // return response
    return(response)
  }
            ...
            <div className=" w-full rounded-sm md:border border-gray-200 md:p-2">
              <div className="flex items-center justify-between mt-3">
                <div className="flex space-x-3 md:space-x-4 items-center">
                  ...
                  >
                    <img src={getUserDp(post.username)}></img>
                  </div>
                  <div>
                            ...
                            <div className="flex space-x-3 md:space-x-4 items-center mt-3">
                              ...
                              <div>
                                <p className="text-sm">
                                  ...
                                  <span>
                                    this is the whole caption with lots of
                                    hashtags #this #that
                                  </span>
                                </p>
                              </div>
